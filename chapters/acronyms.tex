...
\begin{acronym}[Chemicalvapour]
	...
	\acro{mb}[\fonts{12}{18}$\mu_B$]{Bohr magneton}
	\acro{lapw}[\fonts{12}{18}LAPW]{Linearized Augmented Plane Wave}
	\acro{lsda}[\fonts{12}{18}LSDA]{Local Spin Density Approximation}
